                ...
                <div className="container mx-auto px-4 sm:px-6 lg:px-8">
                    ...
                    <div className="text-center mb-16 animate-fade-in">
                        ...
                        <p className="text-xl text-gray-400 max-w-2xl mx-auto">
                            From early MLS identification to European academy validation
                        </p>
                    </div>
                            ...
                            >
                                ...
                                <div className="grid grid-cols-1 md:grid-cols-12 gap-8 items-center">
                                    ...
                                    <div className="md:col-span-3 flex md:flex-col items-center md:items-start space-x-4 md:space-x-0 md:space-y-4">
                                        <div className="flex-shrink-0 w-16 h-16 bg-gradient-to-br from-benfica-red to-red-700 rounded-full flex items-center justify-center text-3xl shadow-lg z-10">
                                            {highlight.icon}
                                        </div>
                    ...
                    <div className="max-w-5xl mx-auto mt-20">
                        <div className="bg-gradient-to-r from-benfica-red to-red-700 rounded-2xl p-8 sm:p-12 text-white">
                            <div className="grid grid-cols-1 sm:grid-cols-3 gap-8 text-center">
                                <div className="space-y-2">
                                    <Award className="w-12 h-12 mx-auto mb-3" />
                                    <div className="text-4xl font-display font-bold">2</div>
                                ...
                                <div className="space-y-2">
                                    ...
                                    <div className="text-4xl font-display font-bold">1</div>
                                    <div className="text-white/90 uppercase tracking-wide text-sm">
                                        Year Benfica Contract
                                    </div>
                                </div>
                            </div>
                        </div>
