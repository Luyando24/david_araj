...
import { Mail, Clock, User, Phone, MessageSquare, Trash2, RefreshCw } from 'lucide-react';
                        ...
                        {loading && !error ? (
                            ...
                            <div className="space-y-4">
                                {contacts.map((contact) => (
                                    <div
                                        key={contact.id}
                                        className="bg-gray-900 rounded-xl p-6 border border-gray-800 hover:border-benfica-red/50 transition-all duration-200"
                                    >
                                        <div className="flex items-start justify-between mb-4">
                                            <div className="flex-1">
                                                <div className="flex items-center space-x-3 mb-2">
                                                    <User className="w-5 h-5 text-benfica-gold" />
